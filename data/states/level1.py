...
class Level1(tools._State):
    def __init__(self, reference_to_container):
        tools._State.__init__(self)
        self.reference_to_container = reference_to_container
    ...
    def adjust_mario_position(self):
        ...
        self.reference_to_container.set_x(self.mario.rect.x) #pass the value to the other program
